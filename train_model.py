...
#
    ...
    for epoch in range(epochs):
        ...
        for i in range(0, len(road), batches):
            ...
            road_batch, minimap_batch, speed_batch, y_batch = road[indices], minimap[indices], speed[indices], training_data_Y[indices].float()
...
if __name__== "__main__":
    training(learning_rate=0.01, epochs=50, neural_net_name="nvidia_arch", batches=32, neural_net_folder_name="default")